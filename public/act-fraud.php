...
<body>
    ...
    $prediksi = $klasifikasi->predict([$jarak_rumah, $jarak_transaksi, $rasio_harga, $pembelian_ulang, $chip, $pin, $pesanan_online]);

    if ($prediksi == 'ya') {
        $hasil = "<font color=red>Diindikasikan Penyalahgunaan Akun</font>";
    } else {
        $hasil = "<font color=green>Akun Anda Aman</font>";
    }

    if ($jarak_rumah == "" or $jarak_transaksi == "" or $rasio_harga == "" or $pembelian_ulang == "" or $chip == "" or $pin == "" or $pesanan_online == "") {
        ...
        <table class=table table-striped table-bordered>
            ...
            <tbody>
                ...
                <tr>
                    <td>Jarak dari Transaksi Terakhir</td>
                    <td>$jarak_transaksi</td>
                </tr>
                <tr>
                    <td>Rasio Median Harga Pembelian</td>
                    <td>$rasio_harga</td>
                </tr>
                <tr>
